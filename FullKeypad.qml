...
Rectangle {
    ...
    Rectangle{
        ...
        Grid {
            ...
            Button {id:buttonLsh; width: keyboard.width/6;height: keyboard.height/6 ; font.bold: true; font.pixelSize: 15; text: "Lsh"}
            ...
            Button {id:buttonCE; width: keyboard.width/6;height: keyboard.height/6 ; font.bold: true; font.pixelSize: 18; text: "CE"}//; onClicked: resultText.text = ''; }
            Button {id:buttonClear; width: keyboard.width/6;height: keyboard.height/6 ; font.bold: true; font.pixelSize: 18; text: "C"}//; onClicked: {resultText.text = ''; expressionText.text = '';}}
            Button {id:buttonBackspace; width: keyboard.width/6;height: keyboard.height/6 ; font.bold: true; font.pixelSize: 18; text: "<x]"}
